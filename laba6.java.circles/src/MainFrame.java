...
// не распахнуто на весь экран
    ...
    private JMenuItem pauseBigItem;
...
// доступными - сделать доступным "Паузу"
        ...
        Action resumeAction = new AbstractAction("Возобновить движение") {
            public void actionPerformed(ActionEvent event) {
                ...
                pauseBigItem.setEnabled(true);
            }
        };
        resumeMenuItem = controlMenu.add(resumeAction);
        resumeMenuItem.setEnabled(false);

        // метод для остановки больших
        Action pauseGreen = new AbstractAction("Приостановить большие") {
            public void actionPerformed(ActionEvent event) {
                field.pauseBig();
                pauseMenuItem.setEnabled(true);
                resumeMenuItem.setEnabled(true);
        ...
        pauseBigItem = controlMenu.add(pauseGreen);
        pauseBigItem.setEnabled(true);
